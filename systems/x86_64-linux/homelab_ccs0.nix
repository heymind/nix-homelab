...
in {
  ...
  networking.firewall.allowedTCPPorts = [80 443 8443 22 wg.listenPort];
  networking.firewall.allowedUDPPorts = [wg.listenPort];
  networking.firewall.interfaces."wg0" = {
    allowedTCPPorts = [5201 5000];
    allowedUDPPorts = [5201 5000];
  };
  ...
  services.udev.extraRules = ''
    ATTR{address}=="00:16:3e:d4:78:c8", NAME="eth0"
  '';
}
